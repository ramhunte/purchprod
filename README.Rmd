...
<!-- badges: start -->
[![Codecov test coverage](https://codecov.io/gh/ramhunte/purchprod/graph/badge.svg)](https://app.codecov.io/gh/ramhunte/purchprod)
...
- Select a specific year of interest and compare it to another year or average over multiple years
...
**Contact us**
- Get in touch with NOAA developers or app managers for support or suggestions

---

## 📊 Data

The app uses data collected annually from participants in the West Coast Groundfish Trawl Fishery.  
As of **April 2025**, the app contains data through the **2023 calendar year**.

Data collection is part of NOAA’s [Economic Data Collection Program](https://www.fisheries.noaa.gov/west-coast/science-data/economic-data-collection-west-coast-groundfish-trawl-fishery).
